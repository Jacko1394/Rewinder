...
namespace Jacko1394.Watcher.Google {
    ...
    /// </summary>
    public class DiffMatchPatch : IDiffMatchPatch {
        // Defaults.
        // Set these on your diff_match_patch instance to override the defaults.

        // Number of seconds to map a diff before giving up (0 for infinity).
        public const float Diff_Timeout = 1.0f;

        // Cost of an empty edit operation in terms of edit characters.
        public const short Diff_EditCost = 4;
        ...
        public const int Match_Distance = 1000;

        // When deleting a large block of text (over ~64 characters), how close
        // do the contents have to be to match the expected contents. (0.0 =
        // perfection, 1.0 = very loose).  Note that Match_Threshold controls
        // how closely the end points of a delete need to match.
        public const float Patch_DeleteThreshold = 0.0f;

        // Chunk size for context length.
        public const short Patch_Margin = 4;
        ...
        public List<Diff> diff_main(string text1, string text2, bool checklines) {
            ...
            var deadline = DateTime.Now + new TimeSpan(((long)(Diff_Timeout * 1000)) * 10000);
         ...
         *      bool values.
         */
        public PatchResult patch_apply(List<Patch> patches, string text) {
            ...
            text = text.Substring(nullPadding.Length, text.Length - (2 * nullPadding.Length)).TrimEnd() + Environment.NewLine;
            return new PatchResult(text, results);
        }
